...
load("C:/Users/clevans/OneDrive - King County/04_Rider_NonRider2020/Metro_EMC_RiderNonRider/2022 Q4/Q4 Datasets/22-8629 KCM Q4 Raw Data Subset 2.2.RData")
data$wave<-20224
...
data <- data %>%
  rename(uniqueid = externalreference,
         ...
         hear_source_localtv = hear_source_1,
         hear_source_localonline = hear_source_2,
         hear_source_localradio = hear_source_3,
         hear_source_natlnews = hear_source_4,
         hear_source_socialmedia = hear_source_5,
         hear_source_other = hear_source_98,
         hear_source_other_txt = hear_source_6_text,
         hear_source_dk = hear_source_99,
         hear_source_donthear = hear_source_8,
...
dropvars<-c("age_elig", "age_year", "age_cat", "other_partic", "kcres", "route_other_1","route_other_2", "route_other_3", 
            ...
            "prim_trip_outside", "prim_trip_outside_5_text", "prim_trip_purp","prim_trip_areas", "prim_trip_areas_sr_dCoded",
...
save(data, file = "Data_2022_4.RData")