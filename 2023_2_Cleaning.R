...
load("C:/Users/clevans/OneDrive - King County/04_Rider_NonRider2020/Metro_EMC_RiderNonRider/2023 Q2/Datasets/23-8914 KCM Q2 Raw Data Subset 8.1.RData")
data$wave<-20232
...
data <- data %>%
  dplyr::rename(uniqueid = externaldatareference,
        ...
        # transit_mode_other_txt=transit_mode_98_text,
         ...
         southsoundadd_ampeak = southsound_addserv_1,
         southsoundadd_pm = southsound_addserv_2,
         southsoundadd_midday = southsound_addserv_3,
         southsoundadd_night = southsound_addserv_4,
         southsoundadd_wknd = southsound_addserv_5,
         southsoundadd_cars = southsound_addserv_6,
         southsoundadd_na = southsound_addserv_95, 
         southsoundadd_dk = southsound_addserv_99,
         
         southsoundpurp_work=southsound_purpose_1,
         southsoundpurp_school=southsound_purpose_2,
         southsoundpurp_childcare=southsound_purpose_3,
         southsoundpurp_shopping=southsound_purpose_4,
         southsoundpurp_fun=southsound_purpose_5,
         southsoundpurp_special=southsound_purpose_6,
         southsoundpurp_medical=southsound_purpose_7,
         southsoundpurp_socserv=southsound_purpose_8,
         southsoundpurp_judicial=southsound_purpose_9,
         southsoundpurp_other=southsound_purpose_98,
         southsoundpurp_other_txt=southsound_purpose_98_text,
         southsoundpurp_alltrips=southsound_purpose_95,
         southsoundpurp_dk=southsound_purpose_99,
  )
...
#rapidrideh_area<-list(98104, 98106, 98126, 98136, 98116, 98146, 98168, 98134, 98166, 98148, 98166, 98198)
#data$rapidrideh_area<-NA
#data$rapidrideh_area[data$zipcode %in% rapidrideh_area]<-1
#data$rapidrideh_area[!data$zipcode %in% rapidrideh_area]<-0


save(data, file = "Data_2023_2.RData")
